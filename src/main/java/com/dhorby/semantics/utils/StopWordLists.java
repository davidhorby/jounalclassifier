...
public class StopWordLists {
    ...
    private static final List<String> bmcStopWords = Arrays.asList(
    ...
    public static final CharArraySet bmcStopSet = new CharArraySet(StopWordLists.bmcStopWords, false);
    public static final CharArraySet phraseSet = new CharArraySet(StopWordLists.bmcStopWords, false);
}
